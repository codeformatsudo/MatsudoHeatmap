...
L.TimeDimension.Layer.SODAHeatMap = L.TimeDimension.Layer.extend({
    ...
    initialize: function(options) {
        ...
        this._period = this.options.period || "P1D";
    },
    ...
    _getFileName: function(time) {
        ...
        console.log('data/kiken_Hour_' + startDate.format('dd') + '.json');
        return 'data/kiken_Hour_' + startDate.format('dd') + '.json';
    }
...
var map = L.map('map', {
    ...
    timeDimensionOptions: {
        ...
        timeInterval: "2016-01-04/2016-01-22", 
        period: "P1D"
